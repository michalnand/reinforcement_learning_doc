...
\begin{frame}
  ...
  \centering{\includegraphics[scale=0.2]{../images/motors/durometerchart.png}} \\
  \centering{\includegraphics[scale=0.03]{../images/motors/tires_1.jpg}} \\
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \centering{\includegraphics[scale=0.4]{../diagrams/controll/control-line_following.png}}
    \end{column}
...
\begin{frame}
  ...
  \centering{\includegraphics[scale=0.3]{../papers_captions/drone_racing_0.png}}
...
\begin{frame}
  ...
  \centering{\includegraphics[scale=0.3]{../papers_captions/drone_racing_1.png}}
