...
\begin{frame}
  ...
  \frametitle{\bf servo state space model}    
    ...
    \centering{\includegraphics[scale=0.5]{../diagrams/controll/control-servo.png}}
...
\begin{frame}
  ...
  \centering{\includegraphics[scale=0.45]{../diagrams/controll/control-lqri_synth.png}}
...
\begin{frame}
  ...
  \frametitle{\bf image segmentation}    
    ...
    \begin{columns}
      ...
      \begin{column}{0.5\textwidth}
        \centering{\includegraphics[scale=0.25]{../images/segmentation.jpg}}
      \end{column}
...
\begin{frame}
  ...
  \frametitle{\bf convolutional neural network}    
    ...
    \centering{\includegraphics[scale=0.5]{../diagrams/models/models-simple_conv.png}}
...
\begin{frame}
  ...
  \frametitle{\bf resnet}    
    ...
    \centering{\includegraphics[scale=0.5]{../diagrams/models/models-resnet.png}}
...
\begin{frame}
  ...
  \frametitle{\bf segmentation}    
    ...
    \centering{\includegraphics[scale=0.35]{../diagrams/models/models-segmentation.png}}
...
\begin{frame}{\bf stockfish NNUE}

  \centering{\includegraphics[scale=0.2]{../images/nnue.png}}
...
\begin{frame}{\bf exploration by self supervised exploitation}
  ...
  \centering{\includegraphics[scale=0.4]{../images/cnd.png}}
...
\begin{frame}{\bf exploration by self supervised exploitation}
  ...
  \centering{\includegraphics[scale=0.4]{../images/cnd-overview.png}}

\end{frame}

\begin{frame}{\bf exploration by self supervised exploitation}

  \centering{\includegraphics[scale=0.4]{../images/cnd-ppo_model.png}}
